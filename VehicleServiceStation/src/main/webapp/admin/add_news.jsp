...
<div class="container" >
    <div class="row justify-content-center mt-5">
      <div class="col-md-6 p-5" style="width: 50rem;">
        <form class="p-4 needs-validation" method="post" action="/VehicleServiceStation/Admin_News" style="border-radius: 5px ; box-shadow: 0 0 10px rgba(0, 0, 0, 0.9);">
        <div><h3 style="text-align: center; text-decoration: underline; margin-top: 0;">News Detail</h3></div>
          
          <div class="form-group mb-3">
            <label for="description" class="form-label fw-medium">Description</label>
            <textarea class="form-control" name="content"id="description" rows="3" style="border: 0.5px solid black;" placeholder="Abc......" required></textarea>
          </div>
