...
<style>
body{
	background-image: url('/VehicleServiceStation/images/provider.jpg');
...
<h4 style="text-align: center; margin-top: 8px; color:white;">Our Providers</h4>
...
<div class="card border border-warning shadow-0 mb-3" style="width: 18rem;">
  ...
  <div class="card-body">
    ...
    <a href="/VehicleServiceStation/commonjsp/view_services.jsp?pid=<%= p.getProvider_id() %>&companyName=<%= p.getCompany_name() %>&Owner=<%= p.getOwner() %>">view services</a>
  </div>
</div>
</div>
<%}%>
