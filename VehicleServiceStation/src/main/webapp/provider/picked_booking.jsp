...
ArrayList<BookingService>serviceList = dao.viewPickedBooking(provider_Id);
%>

<div><h1 style="text-align: center; text-decoration: underline; margin: 10px;">List of vehicles picked successfully</h1></div>
<form method="post" action="/VehicleServiceStation/Picked_Booking" class="needs-validation" novalidate>
...
<div class="table-responsive">	
    ...
    %>
			...
			<tr>
				<td><%= serialNo++ %></td>
				<th scope="row" class="text-center"><input class="form-check-input" type="checkbox" id="flexCheckDefault" name="bkid" value="<%=bs.getBooking_id()%>"></th>
        		...
        		<th scope="row"><%=bs.getPick_status()%></th>
