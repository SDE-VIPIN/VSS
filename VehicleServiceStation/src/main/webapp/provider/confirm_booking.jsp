...
ArrayList<BookingService>serviceList = dao.viewConfirmedBooking(provider_Id);
%>

<div><h1 style="text-align: center; text-decoration: underline; margin: 10px;">Confirmed Booking</h1></div>

<form method="post" action="/VehicleServiceStation/Confirm_Booking" class="needs-validation" novalidate>
